...
public class InlineResponse2004 {
  ...
  private List<Title> results = null;


  public InlineResponse2004 count(BigDecimal count) {
  ...
  **/
  ...
  public InlineResponse2004 results(List<Title> results) {
    
    this.results = results;
    return this;
  }

  public InlineResponse2004 addResultsItem(Title resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<Title>();
    }
